...
class DetailViewControllerScreen: UIView {
    ...
    public func configAllDelegates(tableViewDelegate: UITableViewDelegate, tableViewDataSource: UITableViewDataSource, scrollViewDelegate: UITableViewDelegate, detailViewScreenDelegate: DetailViewControllerScreenDelegate) {
